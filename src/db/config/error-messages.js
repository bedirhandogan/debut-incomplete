...
const messages = {
  ...
  'auth/user-not-found': 'The user corresponding to the provided email address or uid does not exist.',
  'auth/weak-password': 'The provided password is too weak. Please use a stronger password.',
  ...
  'auth/operation-not-allowed': 'The operation is not allowed for this account.',
  ...
  'auth/provider-already-linked': 'This account is already linked with a different provider.',
  'auth/no-such-provider': 'This provider does not exist or has not been enabled for your Firebase project.',
  'auth/token-expired': 'The Firebase ID token has expired. Please log in again.',
  ...
  'storage/project-not-found': 'No project is configured for Firebase Storage.',
  'storage/quota-exceeded': 'Quota on your Firebase Storage bucket has been exceeded.',
  ...
  'storage/invalid-event-name': 'Invalid event name provided. Please check the event name and try again.',
  'storage/invalid-url': 'Invalid URL provided to refFromURL().',
  'storage/invalid-argument': 'Invalid argument provided. Please check the function documentation and try again.',
  'storage/no-default-bucket':
    'No default bucket has been set. Please set a default bucket before using the Firebase Storage SDK.',
  'storage/cannot-slice-blob': 'Cannot slice blob for upload. Please try uploading again.',
  ...
  'storage/cannot-download': 'Cannot download file. Please check your connection and try again.',
  'storage/cannot-observe': 'Cannot observe the provided path. Please check the path and try again.',
  'storage/server-file-not-found': 'The file on the server does not exist. Please try downloading again.',
  'storage/unable-to-unarchive': 'Unable to unarchive the file. Please try downloading again.',
  'storage/cannot-delete': 'Cannot delete object. Please check your permissions and try again.',
